...
The Gateway uses an extensible approach to protocol adaptation through the use of connectors Adapters. Adapters can be used to adapt a variety of datasources to OPC UA for tranmission into the platform.
